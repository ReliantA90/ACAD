            ...
            <div class="table-responsive">
              <table class="table borderless table-condensed">
                <form class="form-inline" role="form">
                    <div class="form-group">
                      <tr>
                        <td><label for="issue_book_isbn">Book ISBN No.:</label></td>
                        <td>
                          <select id="issue_book_isbn" class="form-control eqtxt">
                            <option>--- Select Book ISBN ---</option>
                          </select>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                        <select id="issue_mem_id" class="form-control eqtxt">
                      ...
                      <tr>
                        ...
                        <td><input type="text" id="issue_copies" class="form-control input-sm eqtxt" id="book_copies"></td>
                      </tr>
                      <tr>    
                      ...
                      <tr align="center">
                        <td colspan="2">
                          <button id="issue_btn" type="submit" class="btn btn-primary logbtn">Issue</button>
                          <button href="#" type="reset" class="btn btn-primary logbtn">Refresh</button>
                        </td>
                      </tr> 
                    </div>
            ...
            <div class="table-responsive">
              <table class="table borderless table-condensed">
                <form class="form-inline" role="form">
                    <div class="form-group">
                      <tr>
                        <td><label for="return_book_isbn">Book ISBN No.:</label></td>
                        <td>
                          <select id="return_book_isbn" class="form-control eqtxt">
                            <option>--- Select Book ISBN ---</option>
                          </select>
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                        <select id="return_member_id" class="form-control eqtxt">
                            <option>--- Select Member ID ---</option>
                          </select>
                        </td>
                      </tr>
                      ...
                      <tr align="center">
                        <td colspan="2">
                          <button id="return_sub_btn" type="submit" class="btn btn-primary logbtn">Submit</button>
                          <button href="#" type="reset" class="btn btn-primary logbtn">Refresh</button>
                        </td>
                      </tr> 
                    </div>
...
<!-- search book records -->
  ...
  <script type="text/javascript" src="js/lib_book_issue1.js"></script>
  <script type="text/javascript" src="js/lib_book_issue3.js"></script>
  <script type="text/javascript" src="js/lib_book_issue4.js"></script>
  <script type="text/javascript" src="js/lib_book_issue5.js"></script>
